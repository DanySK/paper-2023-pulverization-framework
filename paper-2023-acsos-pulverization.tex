...
\author{
\IEEEauthorblockN{
    Nicolas Farabegoli\IEEEauthorrefmark{1},
    Danilo Pianini\IEEEauthorrefmark{1},
    Roberto Casadei\IEEEauthorrefmark{2},
    Mirko Viroli\IEEEauthorrefmark{1}
}
\IEEEauthorblockA{\textit{Department of Computer Science and Engineering} \\
\textit{Alma Mater Studiorum---Università di Bologna}\\
Cesena, Italy \\
\IEEEauthorrefmark{1}\{nicolas.farabegoli,danilo.pianini,mirko.viroli\}@unibo.it}
\IEEEauthorrefmark{2}roby.casadei@unibo.it
}
...
(behaviour, state, communication, sensors, and actuators)}
 that can be deployed with flexibility on the available infrastructure without affecting application functionality. %whose actual host can be decided at deployment time.
%
