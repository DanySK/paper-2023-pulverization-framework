...
The framework allows the system configuration via two distinct \acp{dsl}, one for defining the system's devices and their components,
...
%
Therefore, this work deals 
 with multiple problems and perspectives,
 investigated by multiple research threads.
%
...
Accordingly, 
 ...
 languages for 
 specifying applications (\Cref{sec:rw:whatsw}),
...
\subsection{Application description languages: component models and pulverisation}
\label{sec:rw:whatsw}
%
A comprehensive survey on component-based software engineering is provided in~\cite{vale2016component-based-se}.

%
The approach of specifying in a single codebase 
 parts of the structure, behaviour, or interaction 
