...
%  keywordstyle=\color{blue},
  ...
  keywords=[3]{pulverizedSystem,device,and,deployableOn,startsOn,reconfigures,pulverizationRuntime,onDevice,reconfigurationRules},
%  sensitive=true,
%  morecomment=[l]{//},
%  morecomment=[n]{/*}{*/},
...
and we thus decided to estimate the \ac{epi}~\cite{Grochowski2006EnergyPI}
...
%
The experiment has been open sourced\footnote{\url{https://github.com/nicolasfara/ACSOS-2023-pulverization-evaluation}}
...
%
\begin{figure*}
    \includegraphics[width=.32\linewidth]{figures/cloud_cost-device_consumption-cloud_consumption-distance-device=100.0.pdf}~
    \includegraphics[width=.32\linewidth]{figures/cloud_cost-device_consumption-cloud_consumption-distance-device=300.0.pdf}~
    \includegraphics[width=.32\linewidth]{figures/cloud_cost-device_consumption-cloud_consumption-distance-device=1000.0.pdf}
    \caption{
        Simulation results for 100 (left), 300 (center), and 1000 (right) devices;
...
runtime re-configuration of pulverised \ac{cps} applications.
%
...
In the future,
we plan to extend the \ac{dsl} to support openness and collective reconfiguration policies.
%
The former will allow devices to join and leave the system at runtime,
while the latter will allow reconfigurations to be performed on the basis of a collective state of the system.
%
Concurrently,
