...
\meta{NICOLAS please check if the last sentence is true, if so remove this comment}
%
...
we do not report the entire configuration in this manuscript, but it is available in the companion artifact~\cite{TBD}
\meta{
