...
concerned with the mapping of \emph{software components} to \emph{physical machines}~\cite{DBLP:journals/software/Kruchten95}
 and supported by modeling notations like \emph{UML Deployment diagrams}.
%
...
it allows to express deployment properties of
...
%
A policy that requires to consider the state of multiple hosts would require to resort to the host language's primitive mechanisms and make explicit communications outside the framework,
