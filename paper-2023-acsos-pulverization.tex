...
%
Exploiting this %intriguing infrastructure, 
 however, poses new challenges to \ac{cas} application designers.
%
...
in \acp{cas} called \emph{pulverisation}~\cite{FI2020-pulverization}.
%
