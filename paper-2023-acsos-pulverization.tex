...
%
Given the infrastructure defined above, we simulate also a condition where the \emph{Server} is overloaded and, via pulverization,
we want to lightening the load of the \emph{Server} by moving the $\beta_{werable}$ in the \emph{Smartphones}.
%
